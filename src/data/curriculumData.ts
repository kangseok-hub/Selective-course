...
export const FIELD_DATA: Field[] = [
  {
    ...
    majors: [
      {
        name: '국어국문학과',
        recommendedSubjects: ['화법과 언어', '독서와 작문', '문학', '사회와 문화', '현대사회와 윤리', '연극', '주제 탐구 독서', '문학과 영상', '직무 의사소통', '인문학과 윤리', '논리와 사고', '독서 토론과 글쓰기', '매체 의사소통', '언어생활 탐구', '논술'],
        universityTips: [
      ...
      {
        name: '영어영문학과',
        recommendedSubjects: ['영어Ⅰ', '영어Ⅱ', '영어 독해와 작문', '세계시민과 지리', '세계사', '사회와 문화', '영미 문학 읽기', '심화 영어', '심화 영어 독해와 작문', '국제 관계의 이해', '언어생활 탐구', '세계 문화와 영어', '여행지리'],
        universityTips: [
          { university: '가톨릭대', core: '-', recommended: '인문사회계열 진로 및 적성을 고려하여 교과목 선택 이수' },
      ...
      {
        name: '사학과',
        recommendedSubjects: ['세계사', '사회와 문화', '동아시아 역사 기행', '한문', '언어생활과 한자', '역사로 탐구하는 현대 세계'],
        universityTips: [
          { university: '가톨릭대', core: '-', recommended: '인문사회계열 진로 및 적성을 고려하여 교과목 선택 이수' },
      ...
      {
        name: '철학과',
        recommendedSubjects: ['독서와 작문', '문학', '사회와 문화', '현대사회와 윤리', '주제 탐구 독서', '영미 문학 읽기', '윤리와 사상', '인문학과 윤리', '법과 사회', '인간과 철학', '논리와 사고', '인간과 심리', '매체 의사소통', '언어생활 탐구', '사회문제 탐구', '윤리문제 탐구', '지식 재산 일반', '논술'],
        universityTips: [
          { university: '가톨릭대', core: '-', recommended: '인문사회계열 진로 및 적성을 고려하여 교과목 선택 이수' },
  ...
  },
  {
    ...
    majors: [
      {
        name: '경영학과',
        recommendedSubjects: ['화법과 언어', '독서와 작문', '문학', '대수', '미적분Ⅰ', '확률과 통계', '영어Ⅰ', '영어Ⅱ', '영어 독해와 작문', '세계시민과 지리', '세계사', '사회와 문화', '정보', '제2외국어', '미적분Ⅱ', '기하', '경제 수학', '영어 발표와 토론', '법과 사회', '경제', '윤리와 사상', '국제 관계의 이해', '인공지능 기초', '데이터 과학', '실용 통계', '수학과제 탐구', '실생활 영어 회화', '세계 문화와 영어', '사회문제 탐구', '금융과 경제생활', '제2외국어 문화'],
        universityTips: [
          { university: '가톨릭대', core: '인문사회계열 진로 및 적성을 고려하여 교과목 선택 이수[수학(확률과 통계) 포함]', recommended: '-' },
          { university: '건국대', core: '국어, 사회, 수학(대수, 미적분Ⅰ, 확률과 통계)', recommended: '-' },
          { university: '서울시립대', core: '수학, 영어', recommended: '-' }
        ]
      },
      {
        name: '경제학과',
        ...
        universityTips: [
          ...
          { university: '서울대', core: '미적분Ⅱ, 확률과 통계', recommended: '-' }
        ]
      },
  ...
  },
  {
    ...
    majors: [
      {
        name: '수학과',
        recommendedSubjects: ['대수', '미적분Ⅰ', '확률과 통계', '물리학', '기하', '미적분Ⅱ', '인공지능 수학', '역학과 에너지', '전자기와 양자', '수학과제 탐구', '수학과 문화', '실용 통계', '융합과학 탐구'],
        universityTips: [
          { university: '가톨릭대', core: '수학', recommended: '과목 위계를 고려하여 3과목 이상' },
          { university: '경희대', core: '대수, 미적분Ⅰ, 확률과 통계, 미적분Ⅱ, 기하', recommended: '-' },
          { university: '서울대', core: '미적분Ⅱ, 기하', recommended: '-' }
        ]
      },
      {
        name: '물리학과',
        recommendedSubjects: ['대수', '미적분Ⅰ', '미적분Ⅱ', '기하', '물리학', '역학과 에너지', '전자기와 양자', '수학과제 탐구', '융합과학 탐구'],
        universityTips: [
          { university: '가톨릭대', core: '물리학, 수학', recommended: '물리학 1과목 이상, 수학 3과목 이상' },
          { university: '경희대', core: '대수, 미적분Ⅰ, 확률과 통계, 미적분Ⅱ, 기하, 물리학, 역학과 에너지, 전자기와 양자', recommended: '화학, 물질과 에너지' },
          { university: '서울대', core: '물리학, 미적분Ⅱ, 기하', recommended: '-' }
        ]
      },
      {
        name: '화학과',
        recommendedSubjects: ['대수', '미적분Ⅰ', '확률과 통계', '물리학', '화학', '생명과학', '기하', '미적분Ⅱ', '인공지능 수학', '역학과 에너지', '전자기와 양자', '물질과 에너지', '화학 반응의 세계', '세포와 물질대사', '생물의 유전', '수학과제 탐구', '융합과학 탐구'],
        universityTips: [
          { university: '가톨릭대', core: '화학, 수학', recommended: '화학 1과목 이상, 수학 3과목 이상' },
          { university: '경희대', core: '대수, 미적분Ⅰ, 확률과 통계, 미적분Ⅱ, 화학, 물질과 에너지, 화학 반응의 세계', recommended: '기하, 물리학, 생명과학, [역학과 에너지, 전자기와 양자 중 1과목]' },
          { university: '서울대', core: '화학, 미적분Ⅱ, 기하', recommended: '-' }
        ]
      },
      { name: '생명과학과', recommendedSubjects: ['생명과학', '화학', '미적분Ⅰ', '확률과 통계', '세포와 물질대사', '생물의 유전', '융합과학 탐구'] },
  ...
  },
  {
    ...
    majors: [
      {
        name: '컴퓨터정보공학부',
        recommendedSubjects: ['대수', '확률과 통계', '미적분Ⅰ', '정보', '물리학', '인공지능 기초'],
        universityTips: [
          { university: '가톨릭대', core: '물리학, 수학', recommended: '물리학 1과목 이상, 수학 3과목 이상' },
          { university: '광운대', core: '대수, 미적분Ⅰ, 확률과 통계, 물리학, 정보', recommended: '기하, 미적분Ⅱ, 인공지능 수학, 역학과 에너지, 전자기와 양자, 물질과 에너지' },
          { university: '서울대', core: '미적분Ⅱ, 기하', recommended: '-' }
        ]
      },
      {
        name: '기계공학과',
        recommendedSubjects: ['물리학', '화학', '수학', '기하', '미적분Ⅱ', '역학과 에너지', '전자기와 양자'],
        universityTips: [
          { university: '서울대', core: '물리학, 미적분Ⅱ, 기하', recommended: '-' },
  ...
  },
  {
    ...
    majors: [
      {
        name: '의예과',
        recommendedSubjects: ['미적분Ⅰ', '확률과 통계', '물리학', '화학', '생명과학', '현대사회와 윤리', '물질과 에너지', '화학 반응의 세계', '세포와 물질대사', '생물의 유전', '법과 사회', '융합과학 탐구', '생명과학 실험'],
        universityTips: [
          { university: '가톨릭대', core: '화학, 생명과학, 수학', recommended: '세포와 물질대사, 생물과 유전 포함 3과목 이상, 수학 3과목 이상' },
          { university: '경희대', core: '대수, 미적분Ⅰ, 확률과 통계, 미적분Ⅱ, 화학, 생명과학, [물질과 에너지, 화학 반응의 세계, 세포와 물질대사, 생물의 유전 중 3과목]', recommended: '물리학' },
          { university: '서울대', core: '생명과학', recommended: '기하, 미적분Ⅱ, 과학', note: '과학 교과의 진로선택 과목 중 세포와 물질대사, 생물의 유전을 포함하여 3과목 이상' }
        ]
      },
      {
        name: '약학과',
        recommendedSubjects: ['확률과 통계', '화학', '생명과학', '현대사회와 윤리', '물질과 에너지', '화학 반응의 세계', '세포와 물질대사', '생물의 유전', '법과 사회', '보건', '융합과학 탐구', '화학 실험'],
        universityTips: [
      ...
      { name: '간호학과', recommendedSubjects: ['생명과학', '화학', '사회와 문화', '현대사회와 윤리', '보건', '세포와 물질대사', '생물의 유전'] },
      { name: '물리치료학과', recommendedSubjects: ['생명과학', '물리학', '보건', '운동과 건강', '스포츠 과학', '세포와 물질대사'] },
      { name: '수의예과', recommendedSubjects: ['생명과학', '화학', '미적분Ⅰ', '확률과 통계', '세포와 물질대사', '생물의 유전', '생태와 환경'] },
      { name: '치의예과', recommendedSubjects: ['생명과학', '화학', '물리학', '미적분Ⅰ', '세포와 물질대사', '생물의 유전', '보건'] },
      { name: '한의예과', recommendedSubjects: ['생명과학', '화학', '한문', '윤리와 사상', '인문학과 윤리', '세포와 물질대사', '생물의 유전'] },
  ...
  },
  {
    ...
    majors: [
      {
        name: '초등교육과',
        recommendedSubjects: ['화법과 언어', '독서와 작문', '문학', '대수', '미적분Ⅰ', '확률과 통계', '영어Ⅰ', '영어Ⅱ', '영어 독해와 작문', '세계시민과 지리', '세계사', '사회와 문화', '현대사회와 윤리', '물리학', '화학', '생명과학', '지구과학', '체육1', '체육2', '음악', '미술', '기술·가정', '주제 탐구 독서', '영어 발표와 토론', '교육의 이해', '독서 토론과 글쓰기', '미디어 영어', '사회문제 탐구'],
        universityTips: [
          { university: '서울대', core: '-', recommended: '-' },
          { university: '진주교육대', core: '국어, 수학, 영어, 사회, 과학, 한국사', recommended: '-' },
          { university: '광주교육대', core: '국어, 수학, 영어, 사회, 과학, 한국사', recommended: '-' }
        ]
      },
      {
        name: '국어교육과',
  ...
  },
  {
    ...
    majors: [
      ...
      {
        name: '디자인과',
        recommendedSubjects: ['독서와 작문', '문학', '대수', '확률과 통계', '영어Ⅰ', '영어Ⅱ', '영어 독해와 작문', '미술', '정보', '주제 탐구 독서', '문학과 영상', '미술 창작', '미술 감상과 비평', '인간과 심리', '매체 의사소통', '미디어 영어', '세계 문화와 영어', '여행지리', '사회문제 탐구', '미술과 매체']
      },
      {
        name: '음악학과',
      ...
      {
        name: '체육학과',
        recommendedSubjects: ['독서와 작문', '문학', '대수', '미적분Ⅰ', '확률과 통계', '영어Ⅰ', '영어Ⅱ', '영어 독해와 작문', '사회와 문화', '현대사회와 윤리', '물리학', '생명과학', '정보', '경제', '역학과 에너지', '화학 반응의 세계', '세포와 물질대사', '생물의 유전', '데이터 과학', '매체 의사소통', '실생활 영어 회화', '실용 통계'],
        universityTips: [
      ...
      { name: '스포츠과학과', recommendedSubjects: ['체육1', '체육2', '물리학', '생명과학', '스포츠 과학'] },
  ...
  },
  {
    ...
    majors: [
      {
        name: '자율전공학부',
        recommendedSubjects: ['독서와 작문', '대수', '확률과 통계', '영어Ⅰ', '사회와 문화', '과학의 역사와 문화', '진로와 직업', '인간과 철학', '논리와 사고', '논술'],
        universityTips: [
